 ...
 * @generated
 */
public class AlgorithmProjectSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AlgorithmProjectPackage.DOCUMENTABLE: {
				Documentable documentable = (Documentable)theEObject;
				T result = caseDocumentable(documentable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AlgorithmProjectPackage.DOCUMENTATION: {
				Documentation documentation = (Documentation)theEObject;
				T result = caseDocumentation(documentation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AlgorithmProjectPackage.RESSOURCE: {
				Ressource ressource = (Ressource)theEObject;
				T result = caseRessource(ressource);
				if (result == null) result = caseDocumentable(ressource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AlgorithmProjectPackage.ALGO: {
				Algo algo = (Algo)theEObject;
				T result = caseAlgo(algo);
				if (result == null) result = caseDocumentable(algo);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AlgorithmProjectPackage.FLUX: {
				Flux flux = (Flux)theEObject;
				T result = caseFlux(flux);
				if (result == null) result = caseDocumentable(flux);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
