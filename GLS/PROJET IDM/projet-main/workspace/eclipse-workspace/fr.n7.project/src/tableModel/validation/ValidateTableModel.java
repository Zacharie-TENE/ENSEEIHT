 ...
 * @version 0.1
 */
public class ValidateTableModel {
	...
	private static void afficherResultat(ValidationResult resultat) {
		afficherErreurs("- Tableau", resultat.getRecordedErrorsFor(TableModelPackage.TABLEAU));
		afficherErreurs("- Colonne", resultat.getRecordedErrorsFor(TableModelPackage.COLONNE));
		afficherErreurs("- ImportationTableau", resultat.getRecordedErrorsFor(TableModelPackage.IMPORTATION_TABLEAU));
		afficherErreurs("- ImportationAlgo", resultat.getRecordedErrorsFor(TableModelPackage.IMPORTATION_ALGO));
	}
	...
	public static void main(String... args) {
		...
		TableModelPackage packageInstance = TableModelPackage.eINSTANCE;
		...
		TableModelValidator validator = new TableModelValidator();
