 ...
 * </p>
 * <ul>
 *   <li>{@link expression.impl.ExpressionImpl#getName <em>Name</em>}</li>
 *   <li>{@link expression.impl.ExpressionImpl#getInput <em>Input</em>}</li>
 *   <li>{@link expression.impl.ExpressionImpl#getOutput <em>Output</em>}</li>
...
public class ExpressionImpl extends MinimalEObjectImpl.Container implements Expression {
	...
	public EList<Input> getInput() {
		if (input == null) {
			input = new EObjectResolvingEList<Input>(Input.class, this, ExpressionPackage.EXPRESSION__INPUT);
		}
		return input;
	}
	...
	public Output getOutput() {
		if (output != null && output.eIsProxy()) {
			...
			if (output != oldOutput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExpressionPackage.EXPRESSION__OUTPUT, oldOutput, output));
			}
		}
		return output;
	}
	...
	public void setOutput(Output newOutput) {
		...
		output = newOutput;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionPackage.EXPRESSION__OUTPUT, oldOutput, output));
	}
	...
	public EList<ExpressionElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<ExpressionElement>(ExpressionElement.class, this, ExpressionPackage.EXPRESSION__ELEMENTS);
		}
		return elements;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExpressionPackage.EXPRESSION__NAME:
				return getName();
			case ExpressionPackage.EXPRESSION__INPUT:
				return getInput();
			case ExpressionPackage.EXPRESSION__OUTPUT:
