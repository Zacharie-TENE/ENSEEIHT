 ...
 * @version 0.1
 */
public class ValidateAlgorithmProject {
	...
	private static void afficherResultat(ValidationResult resultat) {
		afficherErreurs("- Algo", resultat.getRecordedErrorsFor(AlgorithmProjectPackage.ALGO));
		afficherErreurs("- Flux", resultat.getRecordedErrorsFor(AlgorithmProjectPackage.FLUX));
		afficherErreurs("- Ressource", resultat.getRecordedErrorsFor(AlgorithmProjectPackage.RESSOURCE));
		afficherErreurs("- Documentation", resultat.getRecordedErrorsFor(AlgorithmProjectPackage.DOCUMENTATION));
	}
	...
	public static void main(String... args) {
		...
		AlgorithmProjectPackage packageInstance = AlgorithmProjectPackage.eINSTANCE;
		...
		AlgorithmProjectValidator validator = new AlgorithmProjectValidator();
